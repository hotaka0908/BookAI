...
今までのコンピューターの歴史を見てもインターフェースはその時代で姿形を変え、人々の目の前に現れてきました。巨大で一部の人が使う「ENIAC」から、技術者がキーボードで命令を出す「CLI」、アイコンやマウスを使うことで一般の人々に広まった「GUI」、そして、世界中に普及したスマートフォンの「タッチ」。形を変えてきたなら、また変わるのが自然な流れ。AIが登場した現在、次なるインターフェースは何なのか？覇権を握るAIデバイスは現れるのか？どんな形で、どんなデバイスなのか？
